...
if plot_spectrum:
    ...
    if (max(lda) > 1999):
        ...
        fig1 = plt.figure()
        plt.plot(lda[mask]*1e-3, t_atmosphere[mask]*100,'k', alpha = 0.2, label='Atmospheric \n transmittance')
        ...
        plt.fill_between(lda[mask]*1e-3,0,100*t_atmosphere[mask],
                     color = 'k',
                     alpha=0.2)
    ...
    if (min(lda)<1999):
        ...
        fig2 = plt.figure()
        plt.plot(lda[mask], (AM1p5[mask]/(1.4*1e9))*100,'k',alpha = 0.2, label='AM1.5')
        ...
        plt.fill_between(lda[mask],0,100*AM1p5[mask]/(1.4*1e9),
                             color = 'k',
                             alpha=0.2)
